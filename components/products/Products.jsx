  ...
  return (
    <main>
        <div className="grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))] gap-4 m-2">{products.map(product => 
            <div key={product.id} className={`${product.rating.count < 200 ? 'opacity-50' : ''} py-2 border border-slate-400 shadow-lg text-center flex flex-col bg-secondary`}>
